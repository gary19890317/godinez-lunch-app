...
public class Lugares {
    ...
    public static ArrayList<Lugar> ejemploLugares() {
        ...
        lugares.add(new Lugar("Yenee' Gendaroo",
         ...
         "Yenee guendaroo Es un rincon istmeño ubicado en la popular colonia Buenos Aires.", 3,new Foto(R.drawable.yenee)));
        
         lugares.add(new Lugar("Fonda Argentina Viaducto",
         "Viaducto M. Alemán #80,Benito Juarez,Atenor Salas,03010 Ciudad de México, D.F.",
         ...
         "Av. Cuauhtémoc 462,Benito Juárez,Parque Delta,Piedad Narvarte, 03000 Ciudad de México, D.F.", 
         -99.1545602,19.4027756, TipoLugar.BAR, 
         5554403379L, "http://www.toks.com.mx",
         "Lo mejor.", 5));
         
         lugares.add(new Lugar("Restaurante Todo Bueno",
         "Calz Legaria,11410 Ciudad de México, D.F.", 
         -99.1968206,19.455112, TipoLugar.RESTAURANTE,
         5559148187L, "",
         "Esl buen sason.", 4));
         
         lugares.add(new Lugar("La Cabaña del Rey",
         "Calz Legaria 46-A,Torre Blanca, Miguel Hidalgo,11280 Ciudad de México, D.F.", 
